    ...
    static class DialogPanel extends JPanel implements ActionListener {
        ...
        private void onOK() {
            ...
            if (selection.equals("Point")) {
                ...
                newFigure = new Arrow(color, x1, y1, x2, y2);
                newFigure.setPopup(view.arrowPopup());
                ...
                newFigure = new Triangle(color, x1, y1, x2, y2);
                newFigure.setPopup(view.trianglePopup());
            } else if (selection.equals("Pentagon")) {
                newFigure = new Pentagon(color, x1, y1, x2, y2);
                newFigure.setPopup(view.pentagonPopup());
            } else if (selection.equals("Star")) {
                newFigure = new Star(color, x1, y1, x2, y2);
